...
In the data table you can see the AppID of the Game, its emulator (not reliable), the date on which this data was last edited, the current build, the newest build (from SteamCMD), and the publication date of that build.
...
Data2 acts the same, yet the exe file location is displayed and stored.
